...
{
    // Для различных режимов отладочный изображений
    // В этих режимах цветом отображается глубена пикселя
