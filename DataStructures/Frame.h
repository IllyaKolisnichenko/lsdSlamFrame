...
private:
    ...
    struct Data
    {
        ...
        float cy[PYRAMID_LEVELS];

        float fxInv[PYRAMID_LEVELS];
        float fyInv[PYRAMID_LEVELS];
        ...
        // so setting this to -1 does NOT invalidate the pixel's depth.
